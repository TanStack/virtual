...
> *slowest* at 100k fixed. The audit predicted this: we eagerly populate
...
- Each page is implemented with the library's *recommended* API. For example,
...
- Single-machine numbers. The *shape* of the comparison transfers across
